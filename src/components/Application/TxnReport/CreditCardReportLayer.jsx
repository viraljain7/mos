...
const CreditCardReportLayer = () => {
  ...
  const API = `${import.meta.env.VITE_APP_API_KEY}/service/credit-card/report`;
...
export default CreditCardReportLayer;
