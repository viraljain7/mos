...
const RechargeReportLayer = () => {
  ...
  const API = `${import.meta.env.VITE_APP_API_KEY}/service/recharge/report`;
...
const searchedUsers = useMemo(() => {
  ...
  return filteredUsers.filter((user) => {
    ...
    return (
      ...
      user?.user?.mobile?.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
      user?.amount?.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
      user?.number?.toString().toLowerCase().includes(searchTerm.toLowerCase())
...
export default RechargeReportLayer;
