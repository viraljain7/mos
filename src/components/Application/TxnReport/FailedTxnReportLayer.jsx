...
import TxnReportShimmerUI from "./Shimmer/TxnReportShimmerUI";
import FilterModal from "./Modal/FilterModal";
import ActionBtnModal from "./Modal/ActionBtnModal";
import { ChevronsLeft, ChevronsRight, Search } from "lucide-react";

const FailedTxnReportLayer = () => {
              ...
              {loading ? (
                ...
                currentItems.map((data) => (
                  <tr key={data.id}>
                    ...
                    <td>  <span className="badge text-sm fw-semibold text-lilac-600 bg-lilac-100 px-20 py-9 radius-4 text-white m-2">
 { data.amount}
                        </span> <br/></td>
...
export default FailedTxnReportLayer;
