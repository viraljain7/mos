...
const PgLayer = ({ onComplete, nextStep }) => {
  ...
  const RiskUndertakingPDF = useMemo(
        ...
        <Page size="A4" style={styles.page}>
          ...
          <Text style={styles.clause}>
            <Text style={styles.boldText}>
              This {agreementConfig.intro} ("Agreement")
            </Text>{" "}
            is made on this {userDetails.date} by and between:
          </Text>

          <Text style={styles.clause}>
            <Text style={styles.boldText}>
              Transact 360 Solutions Pvt. Ltd.
            </Text>
            , a company incorporated under the Companies Act, 2013, having its
            registered office at {userDetails.place}, hereinafter referred to as
            the "Company".
          </Text>
          ...
          <Text style={styles.clause}>
            <Text style={styles.boldText}>{userDetails.fullName}</Text>,
            residing at/with office at {userDetails.place}, hereinafter referred
            to as the "{agreementConfig.role}" {agreementConfig.legalClause}.
          </Text>
          ...
          <View style={styles.userDetails}>
            ...
            <Text>
              Mobile Number: {userDetails.mobileNumber} (Registered Mobile
              Number)
            </Text>
          </View>
          ...
          <View style={styles.footer}>
            <Text>
              This is a system generated document. No physical signature
              required.
            </Text>
          </View>
        </Page>
    ...
    [styles, agreementClauses, userDetails, agreementConfig]
  );
      ...
      <div className="container py-4">
        <div className="card">
          ...
          <div className="card-body">
            <div
              className="terms-container border p-3"
              style={{ height: "400px", overflowY: "auto" }}
            >
              <h6 className="text-center mb-3">{agreementConfig.title}</h6>

              <p>
                <strong>This {agreementConfig.intro} ("Agreement")</strong> is
                made on this {userDetails.date} by and between:
              </p>

              <p>
                <strong>Transact 360 Solutions Pvt. Ltd.</strong>, a company
                incorporated under the Companies Act, 2013, having its
                registered office at {userDetails.place}, hereinafter referred
                to as the "Company".
              </p>
              ...
              <p>
                <strong>{userDetails.fullName}</strong>, residing at/with office
                at {userDetails.place}, hereinafter referred to as the "
            ...
            <div className="d-flex justify-content-end gap-2 mt-4">
              <PDFDownloadLink
                ...
                fileName={`${agreementConfig.title.replace(/\s+/g, "_")}_${
