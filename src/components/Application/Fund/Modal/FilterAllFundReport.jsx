            ...
            <div className="modal-body">
              ...
              <div className="my-2">
                ...
                >
                  ...
                  <option value="Paid">Type 1</option>
                  <option value="Pending">Type 2</option>
                  <option value="Pending">Type 3</option>
                  <option value="Pending">Type 4</option>
                </select>
              </div>
              <div className="my-24">
                <span
...
export default FilterAllFundReport;
